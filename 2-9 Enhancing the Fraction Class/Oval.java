...
public class Oval {
    ...
    public Oval( int x1, int x2, int y1, int y2, boolean filledOval) {
        setx1(x1);
        setx2(x2);
        sety1(y1);
        sety2(y2);
        setFilledOval(filledOval);
        numberOfOvals++;
    }
    ...
    // Mutator for ovalFilled variable
    public void setFilledOval (boolean newFilledOval) {
        filledOval = newFilledOval;
    }
    ...
    // Accessor for filledOval instance variable
    public boolean getfilledOval() {
        return filledOval;
    }
