...
public abstract class Vehicle {
     ...
     */
    public Vehicle(double maxCapableSpeed, int acceleration, int weight) {
    ...
    /**
     * Method to simulate speeding up a vehicle by a certain percentage.
     * @param percentage percentage to speed up by
     */
    public void speedUpByPercentage(int percentage) {
        if (percentage < 0 || percentage > 100) {
            System.err.println("Percentage must be between 0-100. No values have been changed.");
        } else {
            double speedIncrease = (percentage / 100.0) * speed;
